...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v25.9.23"
  WORKING_DIRECTORY "/Users/moses/Lifeguard/build-online/flatbuffers"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/moses/Lifeguard/build-online/flatbuffers'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/moses/Lifeguard/build-online/flatbuffers'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
