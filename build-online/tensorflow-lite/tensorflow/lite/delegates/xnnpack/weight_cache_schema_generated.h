...
struct BufferList FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<uint64_t> *fingerprints() const {
    return GetPointer<const ::flatbuffers::Vector<uint64_t> *>(VT_FINGERPRINTS);
  }
  ::flatbuffers::Vector<uint64_t> *mutable_fingerprints() {
    return GetPointer<::flatbuffers::Vector<uint64_t> *>(VT_FINGERPRINTS);
  }
  /// A list of buffers.
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_FINGERPRINTS) &&
...
struct BufferListBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_fingerprints(::flatbuffers::Offset<::flatbuffers::Vector<uint64_t>> fingerprints) {
    fbb_.AddOffset(BufferList::VT_FINGERPRINTS, fingerprints);
  }
...
inline ::flatbuffers::Offset<BufferList> CreateBufferList(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::Vector<uint64_t>> fingerprints = 0,
...
inline ::flatbuffers::Offset<BufferList> CreateBufferListDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<uint64_t> *fingerprints = nullptr,
    const std::vector<::flatbuffers::Offset<tflite::xnnpack::cache::schema::Buffer>> *buffers = nullptr,
    uint64_t base_offset = 0) {
  auto fingerprints__ = fingerprints ? _fbb.CreateVector<uint64_t>(*fingerprints) : 0;
...
inline void BufferList::UnPackTo(BufferListT *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = fingerprints(); if (_e) { _o->fingerprints.resize(_e->size()); for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->fingerprints[_i] = _e->Get(_i); } } else { _o->fingerprints.resize(0); } }
...
inline ::flatbuffers::Offset<BufferList> CreateBufferList(::flatbuffers::FlatBufferBuilder &_fbb, const BufferListT *_o, const ::flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _fingerprints = _o->fingerprints.size() ? _fbb.CreateVector(_o->fingerprints) : 0;
